...
ENV DATABASE_CONNECTION_URI='mongodb://root:MongoDB2019!@localhost/?authSource=admin&readPreference=primary&ssl=false&directConnection=true'
...
ENV AUTHENTICATION_API_KEY='zYzP7ocstxh3SJ23D4FZTCu4ehnM8v4hu'
ENV AUTHENTICATION_JWT_EXPIRIN_IN=0
ENV AUTHENTICATION_JWT_SECRET='3RFYiiRmvNiokSBrLZzx'
ENV SESSION_SECRET='W0NvZGVDaGF0XTpbU2Vzc2lvbiBTZWNyZXQgS2V5Ll0='
