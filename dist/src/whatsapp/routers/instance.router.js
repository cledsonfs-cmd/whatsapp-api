    ...
    constructor(configService, ...guards) {
        ...
        this.router
            ...
            const response = yield this.dataValidate({
                ...
                execute: (instance) => whatsapp_module_1.instanceController.createInstance(instance, req),
            });
            ...
            .get(this.routerPath('reload'), ...guards, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield this.dataValidate({
                request: req,
                schema: validate_schema_1.instanceNameSchema,
                ClassRef: instance_dto_1.InstanceDto,
                execute: (instance) => whatsapp_module_1.instanceController.reloadConnection(instance),
            });
            return res.status(index_router_1.HttpStatus.OK).json(response);
        }))
        ...
        if (auth.TYPE === 'jwt') {
            this.router.put('/refreshToken', (req, res) => __awaiter(this, void 0, void 0, function* () {
                const response = yield this.dataValidate({
                    ...
                    execute: (instance, data) => whatsapp_module_1.instanceController.refreshToken(instance, data, req),
                });
                return res.status(index_router_1.HttpStatus.CREATED).json(response);
            }));
        }
