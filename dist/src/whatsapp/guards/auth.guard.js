...
function jwtGuard(req, _, next) {
    return __awaiter(this, void 0, void 0, function* () {
        const key = req.get('apikey');
        if (env_config_1.configService.get('AUTHENTICATION').API_KEY === key) {
            return next();
        }
...
function apikey(req, _, next) {
    return __awaiter(this, void 0, void 0, function* () {
        const API_KEY = env_config_1.configService.get('AUTHENTICATION').API_KEY;
        const key = req.get('apikey');
        if (API_KEY === key) {
            return next();
        }
